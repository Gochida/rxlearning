...
function createSuggestionStream(responseStream) {
  ...
  .map(ev => null) // there is a kind of order of operations with merge it seems
  .merge( // with two observables emitting cached/immediate output, anything passed in by merge will come AFTER what it's merged WITH
    responseStream.map(listUser => { // so this responseStream will always emit after refreshClickStream
